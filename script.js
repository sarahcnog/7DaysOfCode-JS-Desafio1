...
if(numeroUm == stringUm){
    if(numeroUm === stringUm){
        console.log('As variáveis numeroUm e stringUm têm o mesmo valor e são do mesmo tipo')
    } else {
...
if(numeroTrinta == stringTrinta){
    if(numeroTrinta === stringTrinta){
        console.log('As variáveis numeroTrinta e stringTrinta têm o mesmo valor e são do mesmo tipo')
    } else {
...
if(numeroDez == stringDez){
    if(numeroDez === stringDez){
        console.log('As variáveis numeroDez e stringDez têm o mesmo valor e são do mesmo tipo')
    } else {
